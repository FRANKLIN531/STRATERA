...
export function buildPasswordResetEmail(code) {
...
export function buildEmployeeMessageEmail(employeeName, subject, body, sentBy, messageType = 'Message') {
  ...
  const typeLabel = escapeHtml(messageType);
